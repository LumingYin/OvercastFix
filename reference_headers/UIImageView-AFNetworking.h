...
@class AFImageResponseSerializer<AFURLResponseSerialization>;
...
@property(retain, nonatomic) AFImageResponseSerializer<AFURLResponseSerialization> *imageResponseSerializer; // @dynamic imageResponseSerializer;
@end
