...
@class AFNetworkReachabilityManager, AFSecurityPolicy, NSArray, NSLock, NSMutableDictionary, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSURLSession, NSURLSessionConfiguration;
